...
def loop(turn, wk, wr, bk):
    queue = deque([(wk, wr, bk, 0, turn)])
    visited = set()
    
    while queue:
        wk, wr, bk, moves, t= queue.popleft()
